...
namespace MovieTheatreWebsite.Controllers
{
    public class SurveysController : Controller
    {
        ...
        public SurveysController(MovieTheatreDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SurveyId,SurveyQuestionId,Description,CreatedDate,ExpiresOn")] Survey survey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SurveyId,SurveyQuestionId,Description,CreatedDate,ExpiresOn")] Survey survey)
        {
